...
<div class="navbar-wrapper">
        ...
        <div class="navbar-inverse" style="background-color: #11d375">
          <div class="container">
        ...
        <div class="sl-slider">
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
            <div class="sl-slide-inner">
              ...
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span>andheri,mumbai</p>
          ...
          <div class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">2 Bed Rooms and 1 Dinning Room Aparment on Sale</a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> kurla,mumbai</p>
              <p>Until he extends the circle of his compassion to all living things, man will not himself find peace.</p>
              <cite>$ 20,000,000</cite>
              </blockquote>
            </div>
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">2 Bed Rooms and 1 Dinning Room Aparment on Sale</a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> parel,mumbai</p>
              <p>Until he extends the circle of his compassion to all living things, man will not himself find peace.</p>
              <cite>$ 20,000,000</cite>
              </blockquote>
            </div>
          ...
          <div class="sl-slide" data-orientation="vertical" data-slice1-rotation="-5" data-slice2-rotation="25" data-slice1-scale="2" data-slice2-scale="1">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">2 Bed Rooms and 1 Dinning Room Aparment on Sale</a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span>dombivli,thane</p>
              <p>Until he extends the circle of his compassion to all living things, man will not himself find peace.</p>
              <cite>$ 20,000,000</cite>
              </blockquote>
            </div>
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-5" data-slice2-rotation="10" data-slice1-scale="2" data-slice2-scale="1">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">2 Bed Rooms and 1 Dinning Room Aparment on Sale</a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> panvel,raigad</p>
              <p>Until he extends the circle of his compassion to all living things, man will not himself find peace.</p>
              <cite>$ 20,000,000</cite>
              </blockquote>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-sm-4">
             <select name="search_price" class="form-control">
                <option>Price</option>
                <option value="1">80lakhs-90lakhs</option>
                <option value="2">1crore- 2crore</option>
                <option value="3">3crore - 4crore</option>
                <option value="4">5crore - above</option>
              </select>
            </div>
            <div class="col-lg-3 col-sm-4">
  ...
  <div class="spacer">
    <div class="row">
      <div class="col-lg-12 col-sm-12 recent-view">
        <p style="font-size: xx-large; color: darkblue;">About Us</p>
        <p style="color: brown;">Sainath & Saurabh real eastate business started by sainath shinde and saurabh khude .<br><a href="about.html">Learn More</a></p>
         <p>This comapany started by two friends about the real eastate properties and the lands<br><a href="about.html">Learn More</a></p>
          <p>In this website if anyone interetsed in prpoperties they can simply buy or rent the property by conatcting us.<br><a href="about.html">Learn More</a></p>
...
<div style="background-color: #0ed57f">
...
<div class="row">
            ...
            <div class="col-lg-3 col-sm-3">
             ...
             <div class="col-lg-3 col-sm-3">
                    <h4>Contact us</h4>
                    <p><b>we will get too u as soon as possible</b><br>
<span class="glyphicon glyphicon-map-marker"></span>suryanagar,vikhroli,mumbai-400083<br>
<span class="glyphicon glyphicon-envelope"></span>www.saurabhsai.com<br>
<span class="glyphicon glyphicon-earphone"></span> +91 9819852829/8169663512</p>
            </div>
        </div>
<p class="copyright">Copyright 2022. All rights reserved by sainath and saurabh 	</p>
